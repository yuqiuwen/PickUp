...
Revision ID: 1c4d4b0ac40e
Revises:
Create Date: 2026-02-10 18:44:53.890644
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("collect_cnt", sa.Integer(), server_default="0", nullable=False),
        sa.Column("like_cnt", sa.Integer(), server_default="0", nullable=False),
        sa.Column("comment_cnt", sa.Integer(), server_default="0", nullable=False),
        sa.Column("share_cnt", sa.Integer(), server_default="0", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("token", sa.String(length=255), nullable=False, comment="邮件链接里携带"),
